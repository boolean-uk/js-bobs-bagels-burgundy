...
describe('Basket', () => {
  ...
  // Test 5.1: create a basket with a medium size and check if size is set correctly
  ...
  // Test 5.2: create a basket with a small size and check if size is set correctly
